...
#             sentences = sent_tokenize(example_content_source)
#             source_sent.extend(sentences)
#
#     print(source_sent)
#     print('Кількість речень: {}'.format(len(source_sent)))
#     return source_sent
...
# Find the PDF path
pdf_path = 'D:/University/Flex/SM-F721B_UM_EU_TT_Eng_Rev.2.0_230126.pdf'
